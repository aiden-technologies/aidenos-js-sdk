...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SkillRunList', function() {
      beforeEach(function() {
        instance = new Askaiden.SkillRunList();
      });

      it('should create an instance of SkillRunList', function() {
        // TODO: update the code to test SkillRunList
        expect(instance).to.be.a(Askaiden.SkillRunList);
      });
