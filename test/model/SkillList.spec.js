...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SkillList', function() {
      beforeEach(function() {
        instance = new Askaiden.SkillList();
      });

      it('should create an instance of SkillList', function() {
        // TODO: update the code to test SkillList
        expect(instance).to.be.a(Askaiden.SkillList);
      });
