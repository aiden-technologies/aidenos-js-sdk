...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SkillToolList', function() {
      beforeEach(function() {
        instance = new Askaiden.SkillToolList();
      });

      it('should create an instance of SkillToolList', function() {
        // TODO: update the code to test SkillToolList
        expect(instance).to.be.a(Askaiden.SkillToolList);
      });
