...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ToolList', function() {
      beforeEach(function() {
        instance = new Askaiden.ToolList();
      });

      it('should create an instance of ToolList', function() {
        // TODO: update the code to test ToolList
        expect(instance).to.be.a(Askaiden.ToolList);
      });
